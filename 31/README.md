...
3. ある Page の子ページが分かる
4. Page の階層構造は変更可能
5. Page には自由に何個でもラベルを付与することができる
6. 同じラベルの Page を取得することができる
7. Page にスターをつけることができる
8. Site ホームでスターがついた Page を取得することができる
9. Space の全ての Page を取得することができる
10. Site ホームで最近表示した Page を取得することができる
11. Site ホームで作業済み Page を取得することができる
12. Team を作成することができる
13. 自分が所属しているチームがわかるし、チームメンバーを取得することができる
14. ライセンスグループごとに権限を付与できる
15. ユーザーは必ずライセンスグループに所属している
16. ユーザーごとに権限を付与できる
